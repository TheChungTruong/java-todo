...
class Ex01 {
	...
	/*
	 * Cho mảng A gồm n phần tử (2 < n < 20). Ak = [0, 100] Viết hàm liệt kê các
	 * phần tử chỉ xuất hiện một lần duy nhất trong mảng. Kết quả trả về được sắp
	 * xếp tăng dần.
	 * 
	 * Input: 3, 15, 21, 0, 15, 17, 21 Output: 0, 3, 17
	 */
